...
class NewsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.labelPostdate.text = "Yesterday"
        cell.labelDetails.text = first.details
        cell.imageProfile.image = UIImage(named: first.imageProfileUrl)
        cell.imageNews.image = UIImage(named: first.imageUrl)
